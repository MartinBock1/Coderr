...
def create_user_profile(sender, instance, created, **kwargs):
    """
    Automatically creates a profile with default values when a new user is created.
    """
    if created:
...
def save_user_profile(sender, instance, **kwargs):
    """
    Ensures that the profile is saved when the user is saved.
    This is a security measure in the event that the link is lost.
    """
    try:
